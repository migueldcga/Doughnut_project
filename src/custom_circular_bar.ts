            ...
            vis.mousemove = function(_event: MouseEvent, d: any) {
                tooltip
                    ...
                    .html(`
                        ...
                        <br><br>Dépassement par rapport au plancher: <b>${user_friendly_number(d.data.metric_value_display)}%</b>
                        <br><br>Plancher social : ${user_friendly_number(d.data.metric_value_ideal)}
                        <br><br><u>Source</u>
                        <br>Valeur actuelle: ${user_friendly_number(d.data.metric_value_current)}
                        <br>Année: ${d.data.metric_year}
                        <br>Source: ${d.data.metric_source}
            ...
            vis.mousemove = function(_event: MouseEvent, d: any) {
                ...
                tooltip
                    ...
                    .html(`
                        ...
                        <br><br>${d.data.metric_description}
                        <br><br>Valeur actuelle:<b> ${user_friendly_number(d.data.metric_value_current)}%</b>
